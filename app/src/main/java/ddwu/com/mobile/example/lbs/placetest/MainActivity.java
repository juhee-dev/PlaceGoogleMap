...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Places.initialize(getApplicationContext(), getString(R.string.api_key)); // getResources(). 생략
        placesClient = Places.createClient(this); // google API 사용 객체 생성
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        markerOptions = new MarkerOptions(); // 지도가 준비되면 마커도 준비시킨다
        Log.d(TAG, "Map ready");
